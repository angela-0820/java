...
private int viti;
/**
 * Konstruktori paparametra qe nderton nje date default  1/1/1970
 * Muajt me 31:Janar,Mars,Maj; Korrik, Gusht, Tetor, Dhjetor
 * Muajt me 30:Prill, Qershor, Shtator, Nentor
 * Muajt me 28 ose 29: Shkurt;
 * Viti quhet i brishte nese numri qe perfaqeson ai plotepjesetohet me 4,
 * por jo me 100 ose plotepjesetohet me  400. Shkurti i vitit i brishte ka 29 dite.
 * 
 */
...
private boolean kontrolloData(int dita, int muaji, int viti){
	...
	if(!vitiBrishti(viti) &&  muaji==2 && dita > 28) return false;
	return true;
}
/**
 * Viti quhet i brishte kur numri i vitit plotepjesetohet me 4  por jo me 100 ose plotepjesetohet me 400
 * @param viti perfaqeson vitin
 * @return true nese viti eshte i brishte, perndryshe false
 */
private boolean vitiBrishti(int viti) {
...
/**
 * 
 * @return muaji variabli i instances muaj
 */
public int getMuaji() {
	return muaji;
}
...
/**
 * 
 * @return viti variabli i instances viti
 */
public int getViti() {
	return viti;
}
...
/**
 * Afishon daten ne formatin dd/mm/yy
 */
@Override
